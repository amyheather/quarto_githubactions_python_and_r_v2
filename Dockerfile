...
ENV CONDA_DEFAULT_ENV=quarto_python_r_v2
ENV PATH="/opt/conda/envs/quarto_python_r_v2/bin:${PATH}"
RUN echo "conda activate quarto_python_r_v2" >> /root/.bashrc
...
ENV RETICULATE_PYTHON=/opt/conda/envs/quarto_python_r_v2/bin/python
